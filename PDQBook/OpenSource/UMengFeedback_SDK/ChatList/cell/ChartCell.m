...
-(void)setCellFrame:(ChartCellFrame *)cellFrame
{
    ...
    if (chartMessage.messageType == kMessageTo) {
        [self.icon sd_setImageWithURL:[NSURL URLWithString:[Singleton shareInstance].currentUser.headImgURL]
                                  placeholderImage:[UIImage imageNamed:@"PersonInfo_HeadIMG_Holder"]
...
//        self.icon.image=[UIImage imageNamed:chartMessage.icon];
        self.icon.image = [UIImage imageNamed:@"Feedback_TI_HeadIMG"];
    }
